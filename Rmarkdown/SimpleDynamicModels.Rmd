...
newparms = list(r=0.03, maxtime=50, maxP=300)
...
# look at results
head(results)
colnames(results)=c("year","Pnew")
ggplot(as.data.frame(results), aes(year,Pnew))+geom_point()+labs(y="Population", "years")
...
filled.contour(diff1(10,10,1,10,30,0.6,1)$conc, xlab="time",ylab="Distance Along Path")
```
